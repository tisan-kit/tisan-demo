...
struct TLV * FUNCTION_ATTRIBUTE get_next_property(struct pando_property *next_property, struct pando_property *property_body)
{
    ...
    return (struct TLV *)((uint8_t *)next_property + sizeof(struct pando_property));
}
